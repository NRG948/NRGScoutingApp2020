...
[assembly: ExportRenderer(typeof(AlertableContentPage), typeof(AlertableContentPageRenderer))]
namespace NRGScoutingApp2020.iOS
{
    public class AlertableContentPageRenderer : PageRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            base.ViewWillAppear(animated);

            if (((AlertableContentPage)Element).EnableBackConfimation)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((AlertableContentPage)Element)?.backAction != null)
                {
                    ((AlertableContentPage)Element)?.backAction.Invoke();
                }
            };
